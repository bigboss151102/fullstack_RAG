...
app.mount("/rag/static", StaticFiles(directory="E:/FILE of Trong/LLMs/retrieval_augmented_generation_project/danang_trip_assisstant/pdf-documents"), name="static")
...
pdf_directory = "E:/FILE of Trong/LLMs/retrieval_augmented_generation_project/danang_trip_assisstant/pdf-documents"
...
add_routes(app, final_chain, path="/rag/stream")
